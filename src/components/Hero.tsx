...
export function Hero({ onSearch, onOpenSubmit, siteConfig }: { onSearch: (query: string) => void, onOpenSubmit: () => void, siteConfig?: any }) {
  const config = siteConfig || {
    heroTitle: 'The site with <span class="text-brand drop-shadow-[0_0_15px_rgba(168,85,247,0.8)]">the best</span> premium and free <span class="text-brand drop-shadow-[0_0_15px_rgba(168,85,247,0.8)]">scripts</span>',
    ...
    <section className="relative pt-32 pb-20 px-4 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center relative z-10">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-7xl font-black italic tracking-tighter text-white mb-2 uppercase leading-[1.1]"
        >
