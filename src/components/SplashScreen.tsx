...
export function SplashScreen({ onComplete }: { onComplete: () => void }) {
  ...
  useEffect(() => {
    ...
    // Set volume to max as requested "más fuerte"
    audio.volume = 1.0;
    ...
    const soundTimer = setTimeout(() => {
      audio.play().catch(e => {
        console.log("Sound impact blocked by browser. This usually requires user interaction first.", e);
        // Fallback: Try to play on first document click if blocked
        playOnInteraction = () => {
          audio.play();
