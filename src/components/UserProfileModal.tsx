      ...
      {isOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center px-4 overflow-y-auto py-10">
          ...
          <motion.div
            ...
            className="relative w-full max-w-5xl bg-[#0a0a0c] border border-white/5 rounded-[48px] overflow-hidden shadow-2xl flex flex-col"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Navigation Header */}
            <div className="p-6 flex items-center justify-between bg-black/50 border-b border-white/5">
              <button 
                onClick={onClose} 
